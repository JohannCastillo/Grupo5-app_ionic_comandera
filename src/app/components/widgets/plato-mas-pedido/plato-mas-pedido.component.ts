...
@Component({
  selector: 'app-plato-mas-pedido',
  templateUrl: './plato-mas-pedido.component.html',
  styleUrls: ['./plato-mas-pedido.component.scss'],
})
export class PlatoMasPedidoComponent implements OnInit
{
  public highchart;
  public data;
  public chart;
