export const environment = {
  production: true,
  firebaseConfig: {
    apiKey: "AIzaSyCQ3pFYeMvnWKVy5fz6KdPMUj6k4mICgjw",
    authDomain: "tp2-comanda-pps---v2.firebaseapp.com",
    databaseURL: "https://tp2-comanda-pps---v2.firebaseio.com",
    projectId: "tp2-comanda-pps---v2",
    storageBucket: "tp2-comanda-pps---v2.appspot.com",
    messagingSenderId: "96129646747",
